...
def vgg16(l2=0, dropout=0):
    ...
    x = keras.layers.Dropout(rate=dropout, name='drop1w')(x, training=True)
    ## Block 2
    ...
    x = keras.layers.Dropout(rate=dropout, name='drop2w')(x, training=True)
    ## Block 3
    ...
    x = keras.layers.Dropout(rate=dropout, name='drop3w')(x, training=True)
    ## Block 4
    ...
    x = keras.layers.Dropout(rate=dropout, name='drop4w')(x, training=True)
    ## Block 5
    x = keras.layers.Conv2D(filters=512, kernel_size=(3,3), strides=(1,1), padding='same', activation='relu',
    ...
    x = keras.layers.Dropout(rate=dropout, name='drop5w')(x, training=True)
    ...
    x = keras.layers.Dropout(rate=dropout, name='drop6')(x, training=True)
